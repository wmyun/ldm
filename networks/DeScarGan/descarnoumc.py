...
class Generator(nn.Module):
    def __init__(self, n_channels=1, out_channels=1, nf=32, batch_norm=True, activation=nn.Tanh, final='tanh', mc=False):
    ...
    def encode(self, x):
        ...
        x2 = self.down2(x1)
        # print(x[0,0,:200,:200])
        # print(x0[0,20,:200,:200])
        # print(x1[0,50,:100,:100])
        # print(x2[0,100,:50,:50])
        #x3 = self.down3(x2)
        return x2
